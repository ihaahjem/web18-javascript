...
//Skole markører
//
    ['Campus Fjerdingen', 59.916224, 10.759697, 0, 'school', 'sirkelmarker.png', '/fjerdingen', 'infovindu-bilder/fjerdingen.jpg', 'Adresse: Chr. Krohgs gate 32, 0186 Oslo', '08.00 – 24.00', '10.00 – 23.00'],
    ['Campus Vulkan', 59.9233391, 10.7503081, 1, 'school', 'sirkelmarker.png', '/vulkan', 'infovindu-bilder/vulkan.jpg', 'Adresse: Vulkan 19, 0178 Oslo', '08.00 – 22.00', '10.00-18.00'],
    ['Campus Brenneriveien', 59.920352, 10.7506041, 2, 'school', 'sirkelmarker.png', '/brenneriveien', 'infovindu-bilder/brenneriveien.jpg', 'Adresse: Brenneriveien 9, 0182 Oslo', '07.30 – 24.00', '10.00 – 23.00'],
    ['Campus Kvadraturen', 59.911015, 10.7439543, 3, 'school', 'sirkelmarker.png', '/kvadraturen', 'infovindu-bilder/hk.jpg', 'Adresse: Kirkegata 24-26, 0153 Oslo', '08.00 – 23.00', '09.00 – 17.00'],
//
//Spisested markører
//
...
//Markers til bruk for å filtrere bysykkelmarkers etter avstand til campusmarkers
...
//Uintializerte variable til kart
var map;
var icon;
var infowindow = new google.maps.InfoWindow();

//globale variabler for userPosition
var userPosition;
var userMarker;
...
//finner sentrum utfra koordinatene til 4 campus. Finner gjennomsnittet av de
function findCenter() {
    for (var i = 0; i < 4; i++) {
...
function initKollektivMarkers() {
    ...
    for (var j = 0; j < kollektivtMarkers.length; j++) {
        ...
        google.maps.event.addListener(marker, 'mouseover', (function (marker, i) {
            ...
            var trikkIconSrc = '<img class="kollImg" id="trikkImg" src="trikk.png"></img>';
            var bussIconSrc = '<img class="kollImg" id="bussImg" src="buss.png"></img>';
            var tbaneIconSrc = '<img class="kollImg" id="tbaneImg" src="tbane.png"></img>';
